...
//         ctx.fillRect(10, 40, this.width, this.height); // create rectangle  
//         }
//     }
// }
...
// let calRectangle = new Rectangle(widthRectangle, heightRectangle);
...
class Temperature{
    ...
    tinhDoF()
    {
        let doF = eval(this.doC * 1.8 + 32);
        console.log(`Độ F là ${doF}`);
        getResultF.innerHTML =  doF;
    }
    //K =℃+ 273.15
    tinhDoKelvin()
    {
        let doKelvin = eval(this.doC + 273.15);
        console.log(`Độ Kelvin là ${doKelvin}`);
        getResultKelvin.innerHTML =  doKelvin;
    }
}

let doCNhap = + prompt("Nhập độ C : ");
let calTemperature = new Temperature(doCNhap);
calTemperature.tinhDoF();
calTemperature.tinhDoKelvin();